...
namespace IngenuityMicro.Nexus
{
    public class Pins
    {
        ...
        public class Pwm
        {
            public const Cpu.PWMChannel Socket1Pin1 = (Cpu.PWMChannel)3;
            public const Cpu.PWMChannel Socket1Pin2 = (Cpu.PWMChannel)4;

            public const Cpu.PWMChannel Socket2Pin1 = (Cpu.PWMChannel)6;
            public const Cpu.PWMChannel Socket2Pin2 = (Cpu.PWMChannel)5;
